...
<html>
  ...
  <body ng-app="myApp" class="ng-cloak">
              ...
              <div class="formcontainer">
		       ...
		       <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.user.country" class="form-control input-sm" placeholder="Enter your Country. [This field is validation free]"/>
                              </div>
                          </div>
                      </div>
	...
	<div class="panel panel-default">
     ...
     <div class="panel panel-default">
                <!-- Default panel contents -->
		<!-- List of ALL Employees & Consultants -->
              <div class="panel-heading"><span class="lead">List of ALL, Employees &Consultants </span></div>
              <div class="tablecontainer">
                  <table class="table table-hover">
                      <thead>
                          <tr>
      ...
      <!-- End of List of ALL, Employees & Consultants -->
